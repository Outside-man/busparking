...
(function () {
  ...
  /**
   * 移动到下一点
   * @param {Point} from 当前坐标
   * @param {Point} to   目标坐标
   */
  LuShu.prototype.moveTo = function (from, to) {
    this._move(from, to, this._tween.linear);
  };

  LuShu.prototype.setIcon = function(iconUrl) {
    this._marker.setIcon(new BMap.Icon(iconUrl, new BMap.Size(25, 13)));
  }

  /**
   * 只有在静止时可点击
   */
  LuShu.prototype.onclick = function (clickHandler) {
    var map = this._map;
    var marker = this._marker;
    map.addEventListener('click', function (e) {
      if (e.overlay.ba === marker.ba) {
        clickHandler(e);
      }
    });
  };
  ...
  baidu.object.extend(LuShu.prototype, {
    ...
    _addMarker: function (callback) {
      ...
      marker.setShadow(new BMap.Icon('/assets/images/transparent.png', new BMap.Size(40, 20)));
