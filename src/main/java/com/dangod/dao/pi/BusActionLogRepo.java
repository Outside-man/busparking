...
public interface BusActionLogRepo extends JpaRepository<BusActionLog, String>, JpaSpecificationExecutor<BusActionLog>{
    ...
    @Query(value = "select * from PI_BUSACTIONLOG where BUSID IN :busIdList and ACTIONTIME >= TO_DATE(:preDate, 'YYYY-MM-DD hh24:mi:ss') and ACTIONTIME <= TO_DATE(:afterDate, 'YYYY-MM-DD hh24:mi:ss') ORDER BY RECID", nativeQuery=true)
